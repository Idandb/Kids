...
const faqs = [
  {
    ...
    a: 'אנחנו עובדים על בסיס הצלחה בלבד: לא קיבלתם קצבה — לא שילמתם שקל. בדיקת הזכאות הראשונית לילד חינם וללא התחייבות, ושכר הטרחה נגבה רק אחרי שהקצבה מתקבלת בפועל, בכפוף למגבלות שכר הטרחה הקבועות בחוק לתביעות ילד נכה.',
  },
  {
  ...
  },
  {
    ...
    a: 'לא. קצבת ילד נכה לא תלויה בהכנסת ההורים בכלל, וגם לא במסגרת החינוכית. ילד שמשולב בכיתה רגילה עם ליווי, או שלומד במסגרת מיוחדת — שניהם יכולים להיות זכאים, לפי התפקוד והצרכים בפועל ולא לפי המסגרת.',
  },
  {
